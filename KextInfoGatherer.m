...
extern CFArrayRef OSKextCreateLoadedKextInfo(CFArrayRef kextIdentifiers);
...
+ (NSMutableArray *)loadedExtensions {
    ...
    for (i = 0; i < count; i++) {
      ...
      //  printKextInfo(kextInfo, &toolArgs);
        ...
        [dict setObject:[NSString stringWithFormat:@"%-18p",(void *)loadAddressValue] forKey:@"Address"];
