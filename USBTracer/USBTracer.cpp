...
#define kTPControllersetPowerState 11
#define kTPEHCIMungeECHIStatus 17
...
ParseArguments ( int argc, const char * argv[] )
{
    ...
    while ( ( c = getopt_long ( argc, ( char * const * ) argv , "b:ad::ctsgmufiTLw::r:CHI:1:2:BSDvVh?", long_options, NULL  ) ) != -1 )
    {
        switch ( c )
        {
            ...
            case 'V':
                fprintf(stdout,"usbtracer version:  " USBTRACE_VERSION "\n");
                break;
...
CollectTraceHub ( kd_buf tracepoint )
{
    ...
    switch ( type )
    {
        ...
        case USB_HUB_TRACE( kTPHubCheckForDeadDevice ):
            ...
            {
                log(info, "Hub", "CheckForDeadHub", parg1, "device(%p) has been unplugged", (void *) (uintptr_t)arg2);
            }
            else if ( arg4 == 9)
            {
                log(info, "Hub", "CheckForDeadHub", parg1, "no hubInterface (%p), device(%p), or pipe", (void*)(uintptr_t)arg2, (void*)(uintptr_t)arg3);
            }
            else if ( arg4 == 10)
            {
...
CollectTraceXHCI ( kd_buf tracepoint )
{
    ...
    switch ( type )
    {
        ...
        case USB_XHCI_TRACE(kTPXHCIAsyncEPCreateTD):
            {
                if (qualifier == DBG_FUNC_START)
                {
                    log (info, "XHCI", "AsyncEPCreateTD", parg1, "USBCommand: %p totalTransferSize: %d offC: 0x%x", (void*)(uintptr_t)arg2, arg3, arg4);
                }
                else if (qualifier == DBG_FUNC_END)
                {
        ...
        case USB_XHCI_TRACE(kTPXHCIAsyncEPScheduleTD):
            {
                ...
                {
                    log (info, "XHCI", "AsyncEPScheduleTD", parg1, "ReadyATD: %p USBCommand: %p CompletionIndex: %d", (void*)(uintptr_t)arg2, (void*)(uintptr_t)arg3, arg4);
                }
            }
            break;
        ...
        case USB_XHCI_TRACE(kTPXHCIAsyncEPScavengeTD):
            {
                ...
                {
                    log (info, "XHCI", "AsyncEPScavengeTD", parg1, "ActiveATD: %p USBCommand: %p", (void*)(uintptr_t)arg2, (void*)(uintptr_t)arg3);
                }
                else if(arg4 == 1)
                {
        ...
        case USB_XHCI_TRACE(kTPXHCIAsyncEPUpdateTimeout):
            {
                ...
                {
                    log (info, "XHCI", "AsyncEPUpdateTimeout", parg1, "USBCommand: %p noDataTimeout: %d time: %d", (void*)(uintptr_t)arg2, arg3, arg4);
                }
                else
                {
                    log (info, "XHCI", "AsyncEPUpdateTimeout", parg1, "ActiveATD: %p returnATransfer: %d", (void*)(uintptr_t)arg2, arg3);
                }
            }
            break;
        ...
        case USB_XHCI_TRACE(kTPXHCIAsyncEPAbort):
            {
                ...
                {
                    log (info, "XHCI", "AsyncEPAbort", parg1, "ActiveATD: %p USBCommand: %p CompletionIndex: %d", (void*)(uintptr_t)arg2, (void*)(uintptr_t)arg3, arg4);
                }
            }
            break;
        ...
        case USB_XHCI_TRACE(kTPXHCIAsyncEPComplete):
            {
                ...
                {
                    log (info, "XHCI", "AsyncEPComplete", parg1, "DoneATD: %p USBCommand: %p CompletionIndex: %d", (void*)(uintptr_t)arg2, (void*)(uintptr_t)arg3, arg4);
                }
            }
            break;
        ...
        case USB_XHCI_TRACE(kTPXHCIWaitForCmd):
        {
            if (qualifier == DBG_FUNC_START)
            {
                log (info, "XHCI", "WaitForCMD", parg1, "TRB: %p, command: %d", (void*)(uintptr_t)arg2, arg3);
            }
            else if (qualifier == DBG_FUNC_END)
            {
                log (info, "XHCI", "WaitForCMD", parg1, "TRB: %p, returning 0x%x", (void *)(uintptr_t)arg2, arg3);
            }
            else if (arg4 == 1)
            {
